...
import {Card, Checkbox, Form, Tabs, ChoiceList, Button, Heading,AppProvider,EmptyState, Layout,Page, Stack, ActionList,  Avatar, ContextualSaveBar, FormLayout,Frame, Loading,Modal, Navigation, SkeletonBodyText, SkeletonDisplayText, SkeletonPage, TextContainer, TextField, Toast, TopBar, Link} from "@shopify/polaris";
...
return(
  <>
    ...
    <Card sectioned title=" Attribute You register as">
